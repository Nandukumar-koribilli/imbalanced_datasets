...
import os
import numpy as np
from src.train_pretrain_mae_wisdm import pretrain_mae
from src.train_finetune_mae_wisdm import finetune_mae

def main():
    parser = argparse.ArgumentParser(
        description="MAE-SHAR: Masked Autoencoder Pre-training for Activity Recognition (WISDM)"
    )
    parser.add_argument('--data_dir', type=str,
                        default=os.path.join('wisdm-dataset', 'raw', 'phone', 'accel'),
    ...
    print(f"===========================================================")
    print(f"           MAE-SHAR Pipeline Start (WISDM)                 ")
    print(f"===========================================================")
    ...
    print("\n===========================================================")
    print(f"           MAE-SHAR Pipeline Complete (WISDM)              ")
    print("===========================================================")

"""
Main entry point for MAE-SHAR + I-SMOTE pipeline on UCI HAR dataset.

This script orchestrates:
1. MAE self-supervised pre-training (reconstruction-based) on balanced sensor data
2. Supervised fine-tuning with a small percentage of labeled data
"""
...
def main():
    ...
    parser.add_argument('--label_ratio', type=float, default=1.0,
                        help='Percentage of labels used in fine-tuning phase (default: 1.0 for 100%)')

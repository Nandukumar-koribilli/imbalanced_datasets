...
def pretrain_shar(data_dir, epochs=50, batch_size=128, lr=0.002, device='cpu'):
    ...
    print("Saved 'results/ismote_distribution.png' showing class balances before and after.")
    plt.close()
    ...
    torch.save(model.encoder.state_dict(), "models/shar_encoder_pretrained_wisdm.pth")
    print("Saved pretrained encoder to 'models/shar_encoder_pretrained_wisdm.pth'.\n")

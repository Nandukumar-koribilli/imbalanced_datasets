...
def pretrain_mae(data_dir, epochs=80, batch_size=128, lr=1.5e-3,
    ...
    """MAE pre-training on UCI HAR (reconstruction-based self-supervised learning)."""
    print("--- Starting MAE Pre-training Phase ---")
    ...
    plt.savefig("results/ismote_distribution_mae.png", bbox_inches='tight')
    print("Saved 'results/ismote_distribution_mae.png'.")
    plt.close()
    ...
    ckpt_path = "models/mae_pretrained_full.pth"
...
if __name__ == "__main__":
    ...
    pretrain_mae("UCI HAR Dataset", epochs=2, device=device)

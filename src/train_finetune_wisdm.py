...
def finetune_shar(data_dir, encoder_path="shar_encoder_pretrained.pth", label_ratio=0.25, epochs=50, batch_size=128, lr=0.001, device='cpu'):
    ...
    num_classes = 18 # 18 classes for WISDM
    ...
    try:
        # Load state dict into the newly created encoder
    ...
    model = SHAR_Classifier(dummy_pretrain.encoder, num_classes=18).to(device)

...
def load_metrics_for(dataset_name="UCI HAR", model_type="MAE"):
...
def load_training_data(dataset_name: str = "UCI HAR"):
...
def load_shar_model(dataset_name, model_type="Contrastive (Original)"):
    ...
    try:
        ...
        if is_mae:
            ...
            classifier_ckpt = "mae_classifier_finetuned.pth"
            encoder_ckpt = "mae_encoder_pretrained.pth"
        else:
...
@st.cache_resource
def load_test_dataset(dataset_name: str = "UCI HAR"):
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ...
    # ── Real training metrics (written by main.py) ──────────
    ...
    if model is None or not os.path.isdir(data_dir):
        ...
        c1, c2 = st.columns(2)
        with c1:
            path = os.path.join(PARENT_DIR, "results", "ismote_distribution_mae.png")
        ...
        with c2:
            path = os.path.join(PARENT_DIR, "results", "confusion_matrix_mae.png")
            if not os.path.exists(path):
        ...
        with sig_col:
            st.markdown("""<div class="section-card"><h3 style="margin-top:0;">📡 Sensor Signals</h3></div>""",
                        unsafe_allow_html=True)
            n_ch = x_in.shape[0]
            # UCI HAR: 3 rows × 3 channels (accelerometer, gyroscope, total_acc).
            if n_ch == 9:
...
<div style="text-align:center; padding:2rem 0 1rem; border-top:1px solid {PALETTE['border']}; margin-top:3rem;">
    <p style="color:{PALETTE['text_muted']} !important; font-size:0.85rem;">
        ...
        <span style="font-size:0.75rem;">UCI HAR Dataset • iSMOTE • Masked Autoencoder (MAE)</span>
    </p>
</div>
""", unsafe_allow_html=True)
